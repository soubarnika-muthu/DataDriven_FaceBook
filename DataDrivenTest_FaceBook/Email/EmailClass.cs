...
namespace DataDrivenTest_FaceBook.Email
{
    ...
    public static void email_send()
    {
        try
        {
            ...
            mail.Body = "mail with facebook report attachmement";
            Attachment attachment;
            attachment = new Attachment(@"C:\Users\soubarnika.v\source\repos\DataDrivenTest_FaceBook\DataDrivenTest_FaceBook\Reports\index.html");
